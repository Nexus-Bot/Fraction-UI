                ...
                <div className="p-6">
                  ...
                  <div className="flex flex-row">
                    ...
                    <input
                      ...
                      className="min-w-0 block w-28 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-emerald-900 focus:outline-none"
                      type="number"
                      name="fractionCount"
                      required
                    />
                  ...
                  <div className="relative grid place-items-center h-full mb-12 mt-16">
                    <button
                      ...
                      className="absolute font-sans px-12 py-4 bg-stiletto-500 hover:bg-stiletto-600 text-white font-semibold text-l uppercase rounded"
                    >
                      Fractionalise
                    </button>
                  </div>
